...
class Student1sControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create student1" do
    assert_difference('Student1.count') do
      post student1s_url, params: { student1: { age: @student1.age, nombre: @student1.nombre } }
    end
  ...
  test "should update student1" do
    patch student1_url(@student1), params: { student1: { age: @student1.age, nombre: @student1.nombre } }
